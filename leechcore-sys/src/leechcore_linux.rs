...
pub type LC_READ_PAGE_RESULT = DWORD;
pub type PLC_READ_PAGE_RESULT = *mut LC_READ_PAGE_RESULT;
pub const LC_READ_PAGE_RESULT_NONE: LC_READ_PAGE_RESULT = 0;
pub const LC_READ_PAGE_RESULT_SUCCESS: LC_READ_PAGE_RESULT = 1;
pub const LC_READ_PAGE_RESULT_SUCCESS_AFTER_RETRY: LC_READ_PAGE_RESULT = 2;
pub const LC_READ_PAGE_RESULT_UNSUPPORTED_REQUEST: LC_READ_PAGE_RESULT = 3;
pub const LC_READ_PAGE_RESULT_COMPLETER_ABORT: LC_READ_PAGE_RESULT = 4;
pub const LC_READ_PAGE_RESULT_NO_COMPLETION: LC_READ_PAGE_RESULT = 5;
pub const LC_READ_PAGE_RESULT_PARTIAL_COMPLETION: LC_READ_PAGE_RESULT = 6;
pub const LC_READ_PAGE_RESULT_TRANSPORT_ERROR: LC_READ_PAGE_RESULT = 7;
pub const LC_READ_PAGE_RESULT_PROTOCOL_ERROR: LC_READ_PAGE_RESULT = 8;
pub const LC_READ_PAGE_RESULT_UNSPECIFIED_ERROR: LC_READ_PAGE_RESULT = 9;
pub const LC_READ_PAGE_RESULT_NOT_ISSUED: LC_READ_PAGE_RESULT = 10;
extern "C" {
...
extern "C" {
    pub fn LcReadScatterEx(
        hLC: HANDLE,
        cMEMs: DWORD,
        ppMEMs: PPMEM_SCATTER,
        pResults: PLC_READ_PAGE_RESULT,
    ) -> BOOL;
}
extern "C" {
